...
<head>
    ...
    <style type="">
        ...
        .skin-6F6F .main-header .navbar{background-color: #6F6F6F}
        .skin-6F6F .main-header .navbar .nav>li>a{color: #fff;}
        .skin-6F6F .main-header .navbar .nav>li>a:hover,
        .skin-6F6F .main-header .navbar .nav>li>a:active,
        .skin-6F6F .main-header .navbar .nav>li>a:focus,
        .skin-6F6F .main-header .navbar .nav .open>a,
        .skin-6F6F .main-header .navbar .nav .open>a:hover,
        .skin-6F6F .main-header .navbar .nav .open>a:focus,
        .skin-6F6F .main-header .navbar .nav>.active>a{background: rgba(0,0,0,0.1); color: #f6f6f6;}
    </style>
</head>

<body class="hold-transition skin-6F6F layout-top-nav">
<div class="wrapper">
